...
class PIDLagrangian(abc.ABC):  # noqa: B024
    ...
    def __init__(
        ...
        self._pid_kp: float = args.pid_kp
        self._pid_ki: float = args.pid_ki
        self._pid_kd: float = args.pid_kd
        self._pid_d_delay = args.pid_d_delay
        self._pid_delta_p_ema_alpha: float = args.pid_delta_p_ema_alpha
        self._pid_delta_d_ema_alpha: float = args.pid_delta_d_ema_alpha
        self._penalty_max: int = args.penalty_max
        self._sum_norm: bool = args.sum_norm
        self._diff_norm: bool = args.diff_norm
        self._pid_i: float = args.lagrangian_multiplier_init
        ...
        self._cost_limit: float = args.cost_limit
